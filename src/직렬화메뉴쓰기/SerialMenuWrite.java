...
public class SerialMenuWrite {
    ...
    static void menuWrite() {
        map.put("Americano", new CoffeeMenuInfo("Americano", 2500, "Coffee", "아메리카노"));
        map.put("Espresso", new CoffeeMenuInfo("Espresso", 2000, "Coffee", "에스프레소"));
        map.put("latte", new CoffeeMenuInfo("latte", 4000, "Coffee", "카페라떼"));
    }
        ...
        while(true) {
            ...
            switch (inputMenu) {
                ...
                case 3 :
                    ...
                    oos.close(); // 출력을 위한 스트림의 자원을 반납하고 닫음
            }
        }
    }
}
