...
public class Stack1 {
    public static void main(String[] args) {
        ...
        // stack의 사이즈 확인 (값이 몇 개 들어있는지?)
        System.out.println(stack.size()); // 2
        // 해당 값이 포함되어 있는지 여부 확인 (t/f)
