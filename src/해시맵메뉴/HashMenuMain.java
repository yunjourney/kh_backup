...
public class HashMenuMain {
    ...
    static void selectMenu() {
        ...
        while(true) {
            ...
            switch (selMenu) {
                case 1 :
//                    Set<String> keySet = map.keySet(); // 맵의 모든 키를 모아서 반환
...
//                    }
                ...
                case 2 :
                    ...
                    key = sc.next();
                    // containsKey(키) : map 내에 해당 키가 있는 지 확인하여 결과를 반환함
                ...
                case 3 :
                    ...
                    if(map.containsKey(key)) {
                        ...
                        String grp = sc.next();
                        // sc.nextLine(); // 버퍼 비우기(키를 연속으로 입력받다가 이전의 입력받는 문자열이 들어오는 거 방지
                ...
                case 6 :
                    ...
                    return; // break 사용하면 반복문을 벗어나지 못하므로
            }
        }
    }
}
